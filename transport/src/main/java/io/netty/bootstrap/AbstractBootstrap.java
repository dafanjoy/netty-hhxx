...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
	...
	private ChannelFuture doBind(final SocketAddress localAddress) {
		final ChannelFuture regFuture = initAndRegister();// 初始化 NioServerSocketChannel 通道并注册各个 handler，返回一个 future。
	...
	final ChannelFuture initAndRegister() {
		...
		try {
			channel = channelFactory.newChannel(); // 通过 ServerBootstrap 的通道工厂反射创建一个 NioServerSocketChannel
		...
		ChannelFuture regFuture = config().group().register(channel);// 通过 ServerBootstrap 的 bossGroup 注册
